...
class Sally {
 ...
 private:
  ...
  // Sally Forth do while saved token list
  list<Token> doBuffer ;
  ...
  static void doGTHAN(Sally *Sptr) ;
  static void doGTHANEQUAL(Sally *Sptr) ;
  static void doLTHAN(Sally *Sptr) ;
  static void doLTHANEQUAL(Sally *Sptr) ;
